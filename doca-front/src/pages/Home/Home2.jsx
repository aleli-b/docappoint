            ...
            >
                ...
                >
                    ...
                    <Typography sx={{
                        ...
                        Beciegast nveriti vitaesaert viasead asety kertya aset aplicaboserde miafae  <br /> kertyerauas nuytasas dolouas certeasqas sitaesa ertyatya nemo eniptaiades.
                    </Typography>

                    <Link className="anchor" href="#stop">
                        <Box
                            id="circle"
                            sx={{
                                position: "relative",
                ...
                <Box sx={{ display: 'flex', }}>
                    <Box id="left-container">
                        <Box id="middle-text-container">
                            <Box sx={{ pt: 16 }}>
                                <p className="middle-text">Especialistas</p>
                                <p className="middle-text">al instante</p>
                            </Box>
                            ...
                            <Box sx={{ pt: 24, }}>
                                <p className="middle-text">Laboratorios</p>
                                <p className="middle-text">zarpados</p>
                            </Box>
                        </Box>
                        <Box sx={{ pt: 3, pb: 6, borderBottom: "solid 1px gray" }}>
                            <p className="short-description">
                                Beciegast nveriti vitaesaert asety kertyaset aplicabo binerafae kertyu estyasnemo faserans
                            </p>
                            <p className="short-description">
                                Serptaiades kertyaser daesraeds. Casrolern deuhodi taut. Binseqeuntur magni dolqui ratione volmsequesciu orbosas numquam eius modi teincidunt labore celdolore magnam nytasase.
                            </p>
                        </Box>
                        <Box id="check-turnos">
                            <Link href="/especialistas" sx={{ textDecoration: 'none' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, }}>
                                    <Typography sx={{ color: "#145c6c" }}>
                                        <ArrowCircleRightOutlinedIcon />
                                    </Typography>
                                    <Box id="link-text-box">
                                        <p className="link-text">Explora nuestros </p>
                                        <p className="link-text">especialistas verificados</p>
                                    </Box>
                                </Box>
                            </Link>
                        </Box>
                ...
                <Box id="stop" sx={{ bgcolor: "#e0dede", width: "100%", pb: 8, }}>
                    <Box>
                        <p id="help-title">¿Como funciona Docappoint?</p>
                        <p id="help-sub">El servicio de atencion medica inmediata por excelencia</p>
                    </Box>
                        ...
                        <Card sx={{ maxWidth: 250 }}>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    La sarasa sarandea la sara descara de cara a la mara seca la cara para que sera saras lorem ipsum
                                </Typography>
                            </CardContent>
                        </Card>
                        <Card sx={{ maxWidth: 250 }}>
